...
<body>
    ...
    <div class="photo1">
        <img src="photos/Mara.jpg">
    </div>
    <div class="box1">
        <div class="info1">
            <h1>Maria-Florina Begu</h1>
            <h1>maria.b@gmail.com</h1>
            <h1>FII UAIC</h1>
            <h1>Web Designer</h1>
        </div class="media">
    ...
    <div class="photo2">
        <img src="photos/Camelia.jpg">
    </div>
    <div class="box2">
        <div class="info1">
            <h1>Camelia-Beatrice Darie</h1>
            <h1>darie.c@gmail.com</h1>
            <h1>FII UAIC</h1>
            <h1>Web Designer</h1>
        </div class="media">
        <a href="https://www.facebook.com" class="fa fa-facebook"></a>
    ...
    <div class="photo3">
        <img src="photos/bia.jpg">
    </div>
    <div class="box3">
        <div class="info1">
            <h1>Bianca-Gabriela Gheorghitanu</h1>
            <h1>bianca.g@gmail.com</h1>
            <h1>FII UAIC</h1>
            <h1>Web Designer</h1>
        </div class="media">
        <a href="https://www.facebook.com" class="fa fa-facebook"></a>
