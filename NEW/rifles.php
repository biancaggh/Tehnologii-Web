<?php
    ...
    if(isset($_POST['search'])){
        ...
        $query = mysqli_query($con,"SELECT * FROM rifles WHERE title LIKE '%$searchq%' OR type LIKE '%$searchq%' OR place LIKE '%$searchq%' OR cartridge LIKE '%$searchq%' OR barrel LIKE '%$searchq%' OR ef_range LIKE '%$searchq%' OR feed LIKE '%$searchq%' OR material LIKE '%$searchq%'"); 
...
<html lang="en">
    <head>
        <title> Terrorism | Rifles </title>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <link href="rifles.css" rel="stylesheet" type="text/css">
    ...
    <body>
        <div id="menu-bar">
            ...
            <ul class="nav" id="nav" onclick="onClickBoth()">
                ...
                <li><a href="rifles.php"><i class="fa fa-fw fa-exclamation-circle">Worst Attacks</i></a></li>
        ...
        <div class="search-box">
            <form action="rifles.php" method="post">
        ...
        <div class="infos">
            ...
            <div class="container">
                <?php
                    $query = "SELECT * FROM rifles ORDER BY id ASC ";
                    ...
                    if(mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            <div class="weapon">
                                ...
                                <form method="post" action="rifles.php?action=add&id=<?php echo $row["id"]; ?>">
                                <?php
                                ?>
                                    <div class="rifle">
                                        <img src="<?php echo $row["image"]; ?>" class="img-responsive">
                                        <a href="rifle_machine.php?ID=<?php echo $row["id"]; ?>" class="text-info" ><?php echo $row["title"]; ?></a>
                                    </div>
                                </form>
                            </div>
                            <?php
