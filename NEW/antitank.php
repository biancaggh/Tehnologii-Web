...
<body>
    ...
    <div class="box">
            <?php 
               $query="SELECT * FROM antitank limit 1";
               $result = mysqli_query($con,$query);
                    if(mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_array($result)) {
            ?>
            <form method="post" action="antitank.php?ID="<?php echo $row["id"];?>>
            <div>
            ...
            <div class="txt">
                ...
                <ul>
                    ...
                    <li>Calibre: <?php echo $row["calibre"]; ?></li>
                    <li>Cartridge: <?php echo $row["cartridge"]; ?></li>
                    <li>Barrel Lenght:<?php echo $row["barrel"]; ?></li>
