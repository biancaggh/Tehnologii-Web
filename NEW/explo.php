...
<head>
    <title> Terrorism | Explosives & Anti-Tank Weapons | </title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="box">
            <?php 
               $query="SELECT * FROM explosives limit 1";
               $result = mysqli_query($con,$query);
                    if(mysqli_num_rows($result) > 0) {
                        while ($row = mysqli_fetch_array($result)) {
            ?>
            <form method="post" action="explo.php?ID="<?php echo $row["id"];?>>
            <div>
            ...
            <div class="txt">
                <p>Details:</p>
                <ul>
                    <li>Place of Origin: <?php echo $row["place"]; ?>  </li>
                    <li>Type: <?php echo $row["type"]; ?> </li>
                    <li>Warhead: <?php echo $row["warhead"]; ?></li>
                    <li>Diameter: <?php echo $row["diameter"]; ?></li>
                    <li>Engine:<?php echo $row["engine"]; ?></li>
                    <li>Effective Range: <?php echo $row["ef_range"]; ?> </li>
                    <li>Filling: <?php echo $row["filling"]; ?> </li>
                    <li>Feed System: <?php echo $row["feed"]; ?> </li>
